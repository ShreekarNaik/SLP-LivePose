...
\begin{center}
  ...
  {\large Department Project Report\\[1.35cm]}

  {\Huge\bfseries LivePose: Real-Time Multi-Camera 3D Pose Estimation\\[0.45cm]}
  {\Large A Technical Report on Algorithms, Contributions, and Design Evolution\\[1.4cm]}

  {\large \textit{Shreekar Naik}\\[0.3cm]}
  {\large \textit{Roll No. 22B4518}\\[0.9cm]}

  {\large Supervisor: Prof. Priyanshu Agarwal\\[1.1cm]}

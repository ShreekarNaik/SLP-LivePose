...
\title{\textbf{LivePose: Real-Time Multi-Camera 3D Pose Estimation}\\
\large A Technical Report on Algorithms, Contributions, and Design Evolution}
\author{Shreekar Naik}
\date{May 2026}
